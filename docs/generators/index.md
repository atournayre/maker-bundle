...
| [Collection Generator](collection.md) | `make:elegant:collection` | Creates a new collection class |
| [Controller Generator](controller.md) | `make:elegant:controller` | Creates a new controller class |
