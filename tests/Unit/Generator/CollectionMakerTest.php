...
use Atournayre\Bundle\MakerBundle\Generator\CollectionMaker;
...
class CollectionMakerTest extends TestCase
{
    /**
     * @var Environment&\PHPUnit\Framework\MockObject\MockObject
     */
    private Environment $twig;
    private CollectionMaker $maker;

    protected function setUp(): void
    {
        $this->twig = $this->createMock(Environment::class);
        $this->maker = new CollectionMaker(
            $this->twig,
            'TestApp',
            'test-src',
            'TestApp\\Collection',
            'test-src/Collection',
            ['TestApp\\Entity', 'TestApp\\DTO', 'TestApp\\ValueObject']
        );
    }

    /**
     * @covers \Atournayre\Bundle\MakerBundle\Generator\CollectionMaker::commandName
     */
    public function testCommandName(): void
    {
        self::assertEquals('make:elegant:collection', $this->maker->commandName());
    }

    /**
     * @covers \Atournayre\Bundle\MakerBundle\Generator\CollectionMaker::commandDescription
     */
    ...
    /**
     * @covers \Atournayre\Bundle\MakerBundle\Generator\CollectionMaker::configureCommand
     */
    public function testConfigureCommand(): void
    {
        ...
        self::assertContains('list', $optionCalls);
        self::assertContains('map', $optionCalls);
    }

    /**
     * @covers \Atournayre\Bundle\MakerBundle\Generator\CollectionMaker::generate
     */
    public function testGenerate(): void
    {
        // This test is limited because CollectionMaker is a final class
    ...
    public function testGenerateIntegration(): void
    {
        ...
        self::assertTrue($reflection->hasProperty('collectionNamespace'));
        self::assertTrue($reflection->hasProperty('collectionDirectory'));
        self::assertTrue($reflection->hasProperty('allowedNamespaces'));
