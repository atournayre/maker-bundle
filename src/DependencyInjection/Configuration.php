            ...
            ->children()
                ->arrayNode('namespaces')
                    ...
                    ->children()
                        ...
                        ->scalarNode('argumentValueResolver')->defaultValue('App\ArgumentValueResolver')->end()
                        ...
                        ->scalarNode('eventListener')->defaultValue('App\EventListener')->end()
                        ...
                        ->scalarNode('service')->defaultValue('App\Service')->end()
